...
export const DEFAULTS: ParsedClientRequest = {
  request_language: "",
  business_unit: "",
  country: "",
  city: "",
...
export async function getChoiceOptions(): Promise<ChoiceOptions> {
...
export function readContractType(value: unknown): string {
...
export function normalizeChoice(value: string, options: string[]): string {
...
export function normalizeParsedRequest(
  payload: unknown,
